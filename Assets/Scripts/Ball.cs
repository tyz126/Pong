...
public class Ball : MonoBehaviour, IPunObservable
{
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        if (collision.gameObject.tag == "Paddle")
        {
            ...
            rb.velocity = (Quaternion.AngleAxis(45, rb.position.x > 0 ? Vector3.back : Vector3.forward) * collision.contacts[0].normal).normalized * (rb.velocity.magnitude * speedMultiplier);
        }
